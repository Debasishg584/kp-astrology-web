...
T = {
    ...
    "high_promise": {"en": "Strong Promise", "hi": "प्रबल योग", "bn": "প্রবল যোগ"},
    "medium_promise": {"en": "Moderate Promise", "hi": "मध्यम योग", "bn": "মাঝারি যোগ"},
    "low_promise": {"en": "Weak Promise", "hi": "कमजोर योग", "bn": "দুর্বল যোগ"},
    "ruling_planet": {"en": "Karaka", "hi": "कारक ग्रह", "bn": "কারক গ্রহ"},
